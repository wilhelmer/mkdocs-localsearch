...
class SearchPlugin(BasePlugin):
    ...
    def on_post_build(self, config, **kwargs):
        ...
        fetch_shim_code = 'fetch=function(n,e){return new Promise(function(n,e){n({json:function(){return shim_localSearchIndex}})})};'
        search_index = "shim_localSearchIndex = " + self.search_index.generate_search_index() + "; " + fetch_shim_code
